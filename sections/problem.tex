...
\begin{enumerate}[nosep,leftmargin=*]
    \item Can behavior-aware attribution distinguish domain-relevant from domain-irrelevant pretrained data?
    \item How does the FT/PT ratio evolve during fine-tuning epochs?
    \item Does gradient-based attribution outperform lexical methods for biomedical LLMs?
\end{enumerate}
