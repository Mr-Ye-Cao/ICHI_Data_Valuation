...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/fig5a_storage_efficiency.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/fig5b_attribution_accuracy.png}
...
Figure~\ref{fig:storage} and Figure~\ref{fig:accuracy} summarize these findings, showing LARK's advantages in both storage efficiency and attribution accuracy.
